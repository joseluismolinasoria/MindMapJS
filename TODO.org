...
* Planificado
** TODO Probar los ejemplos con ... [3/5]
...
** TODO Implementar prueba de concepto con KineticJS [8/10]
...
** TODO Incluir al procesable el retorno
   SCHEDULED: <2013-03-03 dom>
   - El procesable se va a quedar sólo para el árbol. Mejor untilizar un patrón PubSub
** TODO Implementación de un test de rendimiento. 
   SCHEDULED: <2013-03-10 dom>
...
** TODO El array de aristas se dispara no para de introducir más y más aristas.
   SCHEDULED: <2013-03-03 dom>
** TODO Permitir la opción de borrado de nodos
   SCHEDULED: <2013-03-03 dom>

** TODO El nodo que esta en modo edición debe tener el foco.
   SCHEDULED: <2013-03-03 dom> 
** TODO Ajustar la posición del editor


* Pendiente de planificar
** TODO Implementar el patrón PubSub para manejo de eventos
...
** TODO Implementar un sistema de Layout para el render
   - Por defecto, se dibujará en el forma arborea.
   - Layout Radial.
** TODO Diseñar la página móvil
** TODO Scroll dentro de la capa??
