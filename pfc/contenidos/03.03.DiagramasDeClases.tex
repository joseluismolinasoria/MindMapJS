...
\begin{figure}[tbph]
\centering
\includegraphics[width=0.7\linewidth]{imagenes/diagrama-clase-mm-nodosimple}
...
Un atajo esta compuesto por un nombre\footnote{Ctrl+i}, una función que será ejecutada 
...
\begin{itemize}
\item \textbf{MM.teclado.atajo} constructor de la clase.
\item \textbf{MM.Arista.calcularPuntos:} calcula los puntos para dibujar la curva.
\item \textbf{MM.Arista.render:} dibuja la curva beizer.
\item \textbf{MM.Arista.rendraw:} redibuja la curva beizer para adaptarse a los cambios producidos en su entorno.
\item \textbf{MM.Arista.destroy:} borra y destruye la arista.
...
\begin{figure}[tbph]
\centering
\includegraphics[width=0.7\linewidth]{imagenes/diagrama-clase-mm-teclado-tecla}
\caption{Clase MM.teclado.tecla}
\label{fig:diagrama-clase-mm-teclado-tecla}
\end{figure}
\begin{figure}[tbph]
\centering
\includegraphics[width=0.7\linewidth]{imagenes/diagrama-clase-mm-teclado}
...
\begin{figure}[tbph]
\centering
\includegraphics[width=0.7\linewidth]{imagenes/diagrama-seq-add}
\caption{Diagrama de secuencia add}
\label{fig:diagrama-seq-add}
\end{figure}
\begin{figure}[tbph]
\centering
\includegraphics[width=0.7\linewidth]{imagenes/diagrama-seq-borrar}
\caption{Diagrama de secuencia borrar}
\label{fig:diagrama-seq-borrar}
\end{figure}
\begin{figure}[tbph]
\centering
\includegraphics[width=0.7\linewidth]{imagenes/diagrama-seq-navegacion}
\caption{Diagrama de secuencia navegación}
\label{fig:diagrama-seq-navegacion}
\end{figure}
%\begin{figure}[tbph]
%\centering
%\includegraphics[width=0.7\linewidth]{imagenes/diagrama-seq-nuevo}
%\caption{Diagrama de secuencia nuevo}
%\label{fig:diagrama-seq-nuevo}
%\end{figure}
%\begin{figure}[tbph]
%\centering
%\includegraphics[width=0.7\linewidth]{imagenes/diagrama-seq-plegar}
%\caption{Diagrama de secuencia plegar}
%\label{fig:diagrama-seq-plegar}
%\end{figure}
%\begin{figure}[tbph]
%\centering
%\includegraphics[width=0.7\linewidth]{imagenes/diagrama-seq-teclado}
%\caption{Diagrama de secuencia teclado}
%\label{fig:diagrama-seq-teclado}
%\end{figure}
%\begin{figure}[tbph]
%\centering
%\includegraphics[width=0.7\linewidth]{imagenes/diagrama-seq-zoom}
